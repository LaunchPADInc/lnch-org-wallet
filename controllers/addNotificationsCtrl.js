        ...
        EthAlerts.get(data).then(
          ...
          function errorCallback(response) {
            ...
            if (response.status == 401) {
              ...
              response.data = 'An error occurred. Please verify whether LaunchPAD Alert Node is setted correctly.';
            }
        ...
        EthAlerts.create($scope.request).then(
          ...
          function errorCallback(response) {
            ...
            if (response.status == 401) {
              ...
              errorMessage = 'An error occurred. Please verify whether LaunchPAD Alert Node is setted correctly.';
            }
            else {
